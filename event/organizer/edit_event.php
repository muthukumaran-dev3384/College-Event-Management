...
<label><input type="radio" name="scope" value="college" <?= ($e['event_scope']=='college')?'checked':'' ?>> College</label>
<label><input type="radio" name="scope" value="department" <?= ($e['event_scope']=='department')?'checked':'' ?>> Department</label>
</div>
</div>

<select class="full" name="department">
